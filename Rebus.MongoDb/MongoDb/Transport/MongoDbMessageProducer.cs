...
namespace Rebus.MongoDb.Transport
{
   ...
   /// </summary>
   internal class MongoDbMessageProducer
   {
      ...
      /// </summary>
      private async Task SendManyAsync(IEnumerable<BsonDocument> messageDocuments)
      {
         ...
         {
            IEnumerable<UniqueMessageIdViolationException> uniqueMessageIdExceptions = exception.WriteErrors
      ...
      private BsonDocument CreateMessageDocument(string destinationQueueName, TransportMessage message)
      {
      ...
      /// </summary>
      private static string GetDestinationAddressToUse(string destinationAddress, TransportMessage message)
      {
