...
//        readonly IRebusTime _rebusTime; // IRebusTime
//        readonly MongoDbTransportOptions _mongoDbTransportOptions;
...
//        /// </summary>
//        IMongoCollection<TransportMessageMongoDb> _collectionQueue;
...
//        ConcurrentDictionary<String, IMongoCollection<TransportMessageMongoDb>> _collectionCache = new ConcurrentDictionary<string, IMongoCollection<TransportMessageMongoDb>>();

//        IMongoCollection<TransportMessageMongoDb> GetCollectionFromDestination(string destinationAddress)
//        {
