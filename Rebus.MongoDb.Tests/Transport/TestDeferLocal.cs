...
public class TestDeferLocal : FixtureBase
{
    ...
    async Task RunTest()
    {
        ...
        ITransactionContext tc = AmbientTransactionContext.Current;
        Thread.Sleep(0);
    ...
    static Task SendMessage(IBus clientBus) => clientBus.DeferLocal(TimeSpan.FromSeconds(3), "Test deferred message",
